...
const DATA_KEY = "lcdp-site-data-v2-catalogo-pdf";
const CART_KEY = "lcdp-cart-v2-catalogo-pdf";
...
interface SiteStoreValue {
  ...
  cartCount: number;
  cartTotal: number;
  cartItemsDetailed: Array<{ product: Product; quantity: number; subtotal: number }>;
